...
if(isset($_POST['insert']))
{
	...
	if(!empty($name) && !empty($phone) && !empty($content))
	{
		...
		$sql="INSERT INTO feedback (rr_id,fdescription,status) VALUES ('$rr_id','$content','0')";
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-12">
								<?php 
									$rr_id=$_SESSION['rr_id'];
									$query=mysqli_query($con,"SELECT * FROM `register` WHERE rr_id='$rr_id'");
								...
								?>
                                    ...
                                    <div class="font-18">
                                        ...
                                        <div class="mb-1 text-capitalize"><b>Email:</b> <?php echo $row['5'];?></div>
                                        <div class="mb-1 text-capitalize"><b>Phone:</b> <?php echo $row['2'];?></div>
										<div class="mb-1 text-capitalize"><b>Role:</b> <?php echo $row['4'];?></div>
                                    </div>
									<?php } ?>
                                </div>
                            </div>
